# Copyright 2024 The EasyR1 Authors
#
...
class Runner:
    ...
    def run(self, config: PPOConfig):
        ...
        val_reward_config.reward_function = "examples/reward_function/instruction_reward.py"
        val_reward_config.reward_function_name= "instruction_val_compute_score"
